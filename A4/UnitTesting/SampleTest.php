...
class SampleTest extends TestCase {
    ...
    public function testFinalPriceCalculation() {
        ...
        $this->assertEquals(54.00, $test19_Obj->calcFuel($GoF, $DA, $DD, $UN));
    }

    public function testFuelCalcWithGoodUser() {
        $GoF = 5;
        $DA = "1203 streetname";
        $DD = "12/12/2021";
        $UN = "username2";
    ...
    public function testCompanyTotalProfit() {
        ...
        $this->assertEquals(20, $test22_Obj->finalizeFuel($f_user, $f_gall, $f_DA, $f_DD, $f_sugg, $f_final));
    }

    public function testCompanyTotalTax() {
        $f_user = "username3";
        $f_gall = 1;
        $f_DA = "1203 cheap street drive";
        $f_DD = "12/12/2021";
        ...
        $this->assertEquals(0.16, $test23_Obj->finalizeFuel($f_user, $f_gall, $f_DA, $f_DD, $f_sugg, $f_final));
    }
